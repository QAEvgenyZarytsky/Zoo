...
public class ZmeyGorynych extends Bird {
    private String name = "Zmey Gorynych";
    private double age = 46.3;
    private double weight = 3124.3;

    public ZmeyGorynych(String name, double age, double weight) {
